...
void gog::patch_RtGuiView() {
  ...
  auto playerIf = (dk2::CDefaultPlayerInterface *) (dk2_base + (0x006CEA10 - dk2_virtual_base));
  asm_guiView = &playerIf->f1984__allyWindowText;

  // CDefaultPlayerInterface_createSurfacesForView_42CDF0
  // .text:0042CE95    mov  eax, [esi+eax*4+4]
  auto pos = (void **) (dk2_base + (0x0042CE95 - dk2_virtual_base));
  asm_jumpBack_fix = (void **) (dk2_base + (0x0042CE9B - dk2_virtual_base));

...
/*  0*/ int32_t __cdecl MyLocalStr::v_format(int32_t, char *, ...) { relink_stub(MyLocalStr::v_format); }  /* auto */
/*  4*/ int32_t MyLocalStr::v_resize(int32_t) { relink_stub(MyLocalStr::v_resize); }  /* auto */
/*  8*/ void *MyLocalStr::v_scalar_destructor(char) { relink_stub(MyLocalStr::v_scalar_destructor); }  /* auto */
/*  C*/ int8_t **MyLocalStr::v_assignChar(int8_t *) { relink_stub(MyLocalStr::v_assignChar); }  /* auto */
/* 10*/ void *MyLocalStr::v_assign(char *) { relink_stub(MyLocalStr::v_assign); }  /* auto */
/* 14*/ char **MyLocalStr::v_assignMyStr(MyStr *) { relink_stub(MyLocalStr::v_assignMyStr); }  /* auto */
/* 18*/ int32_t MyLocalStr::v_append(char *) { relink_stub(MyLocalStr::v_append); }  /* auto */
/* 1C*/ int32_t *MyLocalStr::v_appendChar(int8_t *) { relink_stub(MyLocalStr::v_appendChar); }  /* auto */
/* 20*/ void *MyLocalStr::v_appendMyLocalStr(int32_t) { relink_stub(MyLocalStr::v_appendMyLocalStr); }  /* auto */
// -------------------------------------------------------  /* auto */
/*00672EC0*/ void **MyLocalStr::vftable() { return dk2::MyLocalStr_vftable; }  /* auto */
// member functions  -------------------------------------  /* auto */
/*005D7D30*/ bool MyLocalStr::equalTo(char *) { relink_stub(MyLocalStr::equalTo); }  /* auto */
/*005D7F60*/ int32_t MyLocalStr::charPos(int8_t *, int32_t) { relink_stub(MyLocalStr::charPos); }  /* auto */
/*005FE000*/ MyLocalStr *MyLocalStr::constructor(char *, int32_t, int32_t) { relink_stub(MyLocalStr::constructor); }  /* auto */
/*005FE0C0*/ MyLocalStr *MyLocalStr::assignChar(int8_t *) { relink_stub(MyLocalStr::assignChar); }  /* auto */
/*005FE100*/ MyLocalStr *MyLocalStr::assign(char *) { relink_stub(MyLocalStr::assign); }  /* auto */
/*005FE150*/ MyLocalStr *MyLocalStr::assignMyStr(MyStr *) { relink_stub(MyLocalStr::assignMyStr); }  /* auto */
/*005FE180*/ int32_t MyLocalStr::append(char *) { relink_stub(MyLocalStr::append); }  /* auto */

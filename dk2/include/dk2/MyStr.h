...
/*  C*/ virtual const void *v_scalar_destructor(char);  // = 005B9740  /* auto */
/* 10*/ virtual int8_t **v_assignChar(int8_t *);  // = 005B88E0  /* auto */
/* 14*/ virtual const char **v_assign(const char *);  // = 005B8920  /* auto */
/* 18*/ virtual int32_t v_assignMyStr(int32_t *);  // = 005B8970  /* auto */
/* 1C*/ virtual const void *v_assignMySubStr(MySubStr *);  // = 005B89B0  /* auto */
/* 20*/ virtual int32_t *v_append(const char *);  // = 005B8A00  /* auto */
/* 24*/ virtual int32_t *v_appendChar(int8_t *);  // = 005B8A40  /* auto */
/* 28*/ virtual const void *v_appendMySubStr(int32_t);  // = 005B8A70  /* auto */
// -------------------------------------------------------  /* auto */
/*005B86F0*/ const char *malloc(int32_t);  // ------------  /* auto */
/*005B8730*/ void resize(int32_t);  // -------------------  /* auto */
/*005B8770*/ MyStr *copy_constructor(MySubStr *);  // ----  /* auto */
/*005B87E0*/ MyStr *constructor(const char *);  // -------  /* auto */
...
/*005D7C90*/ const char *resizeGetbuf(int32_t);  // ------  /* auto */
/*005D7CB0*/ int32_t resize_0(int32_t);  // --------------  /* auto */
/*005D7E80*/ int32_t findSubstrOffs(const char *, int32_t);  /* auto */

...
/*00555BD0*/ void *destructor(char);  // -----------------  /* auto */
/*00555CC0*/ uint32_t *create(uint32_t *, AABB *);  // ---  /* auto */
/*00555F30*/ uint32_t *recreateBullfrog(uint32_t *);  // -  /* auto */
/*00555FF0*/ AABB *getClientRect(AABB *);  // ------------  /* auto */
/*00556030*/ int32_t *createBackSurface();  // -----------  /* auto */
/*00556180*/ uint32_t *sub_556180(uint32_t *, int32_t *, int32_t);  /* auto */

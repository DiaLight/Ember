...
/*005DCF40*/ void *scalar_destructor(char);  // ----------  /* auto */
/*005DCF60*/ MyCallback_vtbl **destructor();  // ---------  /* auto */
/*005DCFE0*/ uint32_t *registerCallback(uint32_t *);  // -  /* auto */
/*005DD010*/ MouseRgbDxAction *fun4(MouseRgbDxAction *);    /* auto */
/*005DD270*/ char call(MyDxDevice *);  // ----------------  /* auto */
/*005DD310*/ uint32_t *setDinputAndCall(uint32_t *, MyDirectInput *);  /* auto */
// -------------------------------------------------------  /* auto */

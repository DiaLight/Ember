...
/* 1C*/ uint8_t keyboardState[240];  // ------------------  /* auto */
...
/*005DB4F0*/ void *scalar_destructor(char);  // ----------  /* auto */
...
/*005DB650*/ uint32_t *setDxKeyboard(uint32_t *, MyDxKeyboard *);  /* auto */
/*005DB6A0*/ uint32_t *setDxMouse(uint32_t *, MyDxMouse *);  /* auto */

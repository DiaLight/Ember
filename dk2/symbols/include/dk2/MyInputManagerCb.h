...
/*  0*/ // virtual uint32_t *v_f0_call(int32_t, Event0_winShown7 *);  // = 005BC280  /* auto */
/*  4*/ // virtual void *v_f4_scalar_destructor(char);  // = 005BAF40  /* auto */
...
/* 14*/ // virtual uint32_t *v_f14_releaseKeyboard(uint32_t *);  // = 005BC130  /* auto */
/* 18*/ // virtual uint32_t *v_f18_releaseMouse(uint32_t *);  // = 005BC0F0  /* auto */
/*---*/ // MyInputManagerCb  -----------------------------  /* auto */
// -------------------------------------------------------  /* auto */
/*005B2B40*/ uint32_t *static_releaseKeyboard();  // -----  /* auto */
/*005B2B80*/ uint32_t *static_releaseMouse();  // --------  /* auto */
/*005BAF40*/ void *scalar_destructor(char);  // ----------  /* auto */
/*005BAF60*/ uint32_t *destructor();  // -----------------  /* auto */
/*005BB020*/ int32_t setStaticListenersAndHandleDxActions(StaticListeners *, uint32_t, CComponent *);  /* auto */
...
/*005BC270*/ uint32_t *updateMouse(AABB *);  // ----------  /* auto */

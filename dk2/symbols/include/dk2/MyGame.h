...
/*271*/ uint8_t gap271[4];  // ---------------------------  /* auto */
/*275*/ IDirectDrawSurface *zbufferSurf;  // -------------  /* auto */
/*279*/ StaticListeners static_listeners;  // ------------  /* auto */
/*28D*/ int32_t f28D;  // --------------------------------  /* auto */
/*291*/ uint32_t f291;  // -------------------------------  /* auto */
/*295*/ uint32_t f295;  // -------------------------------  /* auto */
/*299*/ uint8_t gap_299[4];  // --------------------------  /* auto */
/*29D*/ int32_t f29D;  // --------------------------------  /* auto */
/*2A1*/ uint8_t gap_2A1[304];  // ------------------------  /* auto */
/*3D1*/ int32_t f3D1;  // --------------------------------  /* auto */
/*3D5*/ uint8_t gap_3D5[304];  // ------------------------  /* auto */
...
/*625*/ uint32_t is_empty_dd[16];  // --------------------  /* auto */
/*665*/ char dds_descs_arr16[16][64];  // ----------------  /* auto */
/*A65*/ char dds_names_arr16[16][64];  // ----------------  /* auto */
/*E65*/ uint32_t dds_count;  // --------------------------  /* auto */
/*E69*/ int32_t selected_dd_idx;  // ---------------------  /* auto */
/*E6D*/ int32_t last_selected_dd_idx;  // ----------------  /* auto */
/*E71*/ uint32_t fE71;  // -------------------------------  /* auto */
/*E75*/ uint32_t fE75;  // -------------------------------  /* auto */
/*E79*/ uint32_t fE79;  // -------------------------------  /* auto */
/*E7D*/ uint32_t fE7D;  // -------------------------------  /* auto */
/*E81*/ int32_t fE81;  // --------------------------------  /* auto */
/*E85*/ uint32_t totalDisplayMemory;  // -----------------  /* auto */
/*E89*/ void (__cdecl *WM_ACTIVATE_callbacks[8])(int32_t, uint32_t, uint32_t, void *);  /* auto */
/*EA9*/ void *WM_ACTIVATE_userData[8];  // ---------------  /* auto */
/*EC9*/ CWindowTest c_window_test;  // -------------------  /* auto */
/*F29*/ uint16_t field_obj;  // --------------------------  /* auto */
/*F2B*/ uint8_t gap_F2B[34];  // -------------------------  /* auto */
...
/*005580E0*/ uint32_t *release();  // --------------------  /* auto */
...
/*005588A0*/ uint32_t *surf_Blt();  // -------------------  /* auto */
/*005589E0*/ Pos2i *getMousePos();  // -------------------  /* auto */
/*005589F0*/ Pos2i *static_getMouseF14();  // ------------  /* auto */
/*00558A40*/ int32_t takeScreenshot();  // ---------------  /* auto */
/*00558BD0*/ int32_t sub_558BD0();  // -------------------  /* auto */
/*00558E40*/ int32_t collect3dDevices();  // -------------  /* auto */
/*00558F40*/ int32_t sub_558F40(uint32_t, MyD3DevInfo *);   /* auto */
/*00558F70*/ int32_t createZBufferSurf(int32_t);  // -----  /* auto */
/*00559140*/ int32_t sub_559140(char *, int32_t, const char *, const char *);  /* auto */
/*00559670*/ int32_t isNeedBlt();  // --------------------  /* auto */
/*00559690*/ int32_t addWmActivateCallback(void (__cdecl *)(int32_t, uint32_t, uint32_t, void *), void *);  /* auto */
/*005596D0*/ int32_t removeWmActivateCallback(int32_t);     /* auto */
/*005597F0*/ GUID *getSelectedGuid();  // ----------------  /* auto */
// -------------------------------------------------------  /* auto */

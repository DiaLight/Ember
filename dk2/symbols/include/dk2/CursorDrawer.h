...
/*  9*/ char ff_9;  // -----------------------------------  /* auto */
/*  A*/ char _00_A;  // ----------------------------------  /* auto */
/*  B*/ uint8_t _00_B;  // -------------------------------  /* auto */
/*  C*/ Pos2i cursorSurfSize;  // ------------------------  /* auto */
/* 14*/ Pos2i cursorSize;  // ----------------------------  /* auto */
/* 1C*/ uint32_t idx;  // --------------------------------  /* auto */
/* 20*/ uint32_t prevIdx;  // ----------------------------  /* auto */
/* 24*/ uint32_t bpt_forceDraw;  // ----------------------  /* auto */
/* 28*/ uint32_t bpt_isCursorAabbIntersectsWithPrevPos;     /* auto */
...
/*005DBF40*/ void *scalar_destructor(char);  // ----------  /* auto */
/*005DBF60*/ void destructor();  // ----------------------  /* auto */
/*005DBF80*/ void updateCursorAndDraw(Pos2i *, MyDdSurfaceEx *);  /* auto */
/*005DC000*/ uint32_t *resetAndReleaseCursorSurfaces();     /* auto */
/*005DC010*/ int32_t *recreateCursorSurfaces(int32_t *);    /* auto */
/*005DC0B0*/ int32_t nextFrame();  // --------------------  /* auto */
/*005DC0F0*/ uint32_t *releaseCursorSurfaces();  // ------  /* auto */
...
/*005DC7D0*/ uint32_t *resetCursorSize(uint32_t *);  // --  /* auto */

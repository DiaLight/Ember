...
/*  8*/ uint32_t fontFlags;  // --------------------------  /* auto */
/*  C*/ uint32_t hasFlag2;  // ---------------------------  /* auto */
/* 10*/ uint32_t hasFlag8;  // ---------------------------  /* auto */
/* 14*/ MySurface surf;  // ------------------------------  /* auto */
/* 3C*/ int32_t f3C;  // ---------------------------------  /* auto */
/* 40*/ int32_t f40;  // ---------------------------------  /* auto */
/* 44*/ PixelMask fontMask;  // --------------------------  /* auto */
/* 49*/ uint8_t gap_49[3];  // ---------------------------  /* auto */
...
/*0062C290*/ void *scalar_destructor(char);  // ----------  /* auto */
...
/*0062C3C0*/ uint32_t *setFontMask(uint32_t *, PixelMask *);  /* auto */
/*0062C410*/ uint32_t *checkFlag8(uint32_t *);  // -------  /* auto */
/*0062C440*/ int32_t *reset_f10(int32_t *);  // ----------  /* auto */
/*0062C470*/ uint32_t *setFont(uint32_t *, MyTextFont *);   /* auto */

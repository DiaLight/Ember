...
/*005DCB70*/ void *MyDxDevice::deleting_destructor(char) { relink_stub(MyDxDevice::deleting_destructor); }  /* auto */
/*005DCB90*/ int32_t MyDxDevice::destructor() { relink_stub(MyDxDevice::destructor); }  /* auto */
/*005DCBB0*/ uint32_t *MyDxDevice::queryDevice(uint32_t *, IDirectInputDeviceA **) { relink_stub(MyDxDevice::queryDevice); }  /* auto */
...
/*005DCE50*/ uint32_t *MyDxDevice::setCoopLevel(uint32_t *, char) { relink_stub(MyDxDevice::setCoopLevel); }  /* auto */
// -------------------------------------------------------  /* auto */

...
/*005FFE50*/ void *MyFileStream::scalar_destructor(char) { relink_stub(MyFileStream::scalar_destructor); }  /* auto */
...
/*005FFFB0*/ uint32_t MyFileStream::readBytes(void *, uint32_t) { relink_stub(MyFileStream::readBytes); }  /* auto */
/*005FFFF0*/ uint32_t MyFileStream::writeBytes(const void *, uint32_t) { relink_stub(MyFileStream::writeBytes); }  /* auto */
/*00600030*/ int32_t MyFileStream::seek(int32_t, uint32_t) { relink_stub(MyFileStream::seek); }  /* auto */
/*00600050*/ uint32_t MyFileStream::getSize() { relink_stub(MyFileStream::getSize); }  /* auto */
/*00600060*/ char *MyFileStream::mapFileToBuf(int32_t, uint32_t) { relink_stub(MyFileStream::mapFileToBuf); }  /* auto */
...
/*00600150*/ uint32_t *MyFileStream::flush(uint32_t *) { relink_stub(MyFileStream::flush); }  /* auto */
// -------------------------------------------------------  /* auto */

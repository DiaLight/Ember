...
/*005D9290*/ uint32_t *MyDiskDirectory::sub_5D9290(uint32_t *, char *, MyFileInfo *) { relink_stub(MyDiskDirectory::sub_5D9290); }  /* auto */
/*005D93E0*/ uint32_t *MyDiskDirectory::sub_5D93E0(uint32_t *, int32_t) { relink_stub(MyDiskDirectory::sub_5D93E0); }  /* auto */
/*005D9450*/ void *MyDiskDirectory::close() { relink_stub(MyDiskDirectory::close); }  /* auto */
/*005D94D0*/ uint32_t *MyDiskDirectory::createFileStream(uint32_t *, TbDiscFile *, char *, int32_t, int32_t) { relink_stub(MyDiskDirectory::createFileStream); }  /* auto */
/*005D9620*/ uint32_t *MyDiskDirectory::setPath(uint32_t *, const char *) { relink_stub(MyDiskDirectory::setPath); }  /* auto */
/*005D96C0*/ int32_t MyDiskDirectory::sub_5D96C0(int32_t, int32_t, uint32_t) { relink_stub(MyDiskDirectory::sub_5D96C0); }  /* auto */

...
bool patch::use_cwd_as_dk2_home_dir() {
    if (!api::replaceXrefs(&dk2::resolveDk2HomeDir, proxy_resolveDk2HomeDir)) return false;
    ...
    replaceExeDir = HookHandle::overwrite(api::dk2_base + (0x0055C19A - dk2_virtual_base), 12);
